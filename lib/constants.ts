...
export const HERO_CONTENT = {
  ...
  description: 'Инженерные решения для очистки оборудования, трубопроводов и поверхностей на базе технологий высокого давления. Восстанавливаем КПД и снижаем эксплуатационные расходы. Платите только за результат.',
  cta: {
