...
export const HERO_CONTENT = {
  ...
  description: 'Очистка котлов, теплообменников, трубопроводов, покрытий и резервуаров. Выезд технолога на осмотр, подбор метода и технологии, тест-очистка — бесплатно.',
  cta: {
