...
export const HERO_CONTENT = {
  ...
  descriptionLine1: 'Очистка котлов, теплообменников, трубопроводов, покрытий и резервуаров.',
...
/** @deprecated Use GALLERY_CARDS instead */
...
export const GALLERY_CARDS: GalleryCard[] = [
  {
    id: 'case-floor-heavy',
    title: 'Очистка пола прокатного цеха',
    description: 'Гидродинамическая очистка с насадкой FRV · До и после в одном кадре',
    method: 'Гидродинамика',
    industry: 'Металлургия',
    poster: '/media/gallery/photos/floor-heavy-before-after.webp',
    video: undefined,
    posterWidth: 1280,
    posterHeight: 720,
  },
  {
    id: 'case-hydro-wall',
    title: 'Гидродинамическая очистка стенки',
    description: 'Удаление промышленных загрязнений со стенки ёмкости · Давление до 500 бар',
    method: 'Гидродинамика',
    industry: 'Промышленность',
    poster: '/media/gallery/photos/hydro-wall-cleaning.webp',
    video: undefined,
    posterWidth: 1280,
    posterHeight: 720,
  },
  {
    id: 'case-reservoir-cryoblast',
    title: 'Криобластинг резервуара',
    description: 'Очистка внутренней поверхности промышленного резервуара сухим льдом · Оборудование Kärcher',
    method: 'Криобластинг',
    industry: 'Химическая промышленность',
    poster: '/media/gallery/frames/case_reservoir_cryoblasting_01_poster.png',
    video: '/media/gallery/videos/case_reservoir_cryoblasting_03_karcher.mp4',
    posterWidth: 1280,
    posterHeight: 720,
  },
  {
    id: 'case-woma-station',
    title: 'Мобильная установка WOMA',
    description: 'Развёртывание мобильной станции на объекте · Очистка полов промышленного цеха',
    method: 'Оборудование',
    industry: 'Металлургия',
    poster: '/media/gallery/photos/woma-station.webp',
    video: undefined,
    posterWidth: 1280,
    posterHeight: 720,
  },
  {
    id: 'case-tank-cutting',
    title: 'Гидроабразивная резка ёмкости',
    description: 'Взрывобезопасная резка металла 6 мм · WOMA EcoMaster MK3 · 2500 бар',
    method: 'Гидроабразивная резка',
    industry: 'Нефтехимия',
    poster: '/media/gallery/frames/case_tank_cutting_01_overview.png',
    video: '/media/gallery/videos/case_tank_cutting_01_overview.mov',
    posterWidth: 1280,
    posterHeight: 720,
  },
  {
    id: 'case-test-cleaning',
    title: 'Тест-очистка для клиентов',
    description: 'Демонстрация криобластинга на площадке Kärcher · Бесплатная тест-очистка',
    method: 'Криобластинг',
    industry: 'Демонстрация',
    poster: '/media/gallery/photos/test-cleaning-demo.webp',
    video: undefined,
    posterWidth: 1280,
    posterHeight: 720,
  },
  {
    id: 'case-vacuum-dust',
    title: 'Вакуумная уборка производства',
    description: 'Взрывобезопасная уборка пыли на металлопрокатном заводе · Промышленные пылесосы Kärcher',
    method: 'Вакуумная уборка',
    industry: 'Металлургия',
    poster: '/media/gallery/photos/vacuum-dust-hall.webp',
    video: '/media/gallery/videos/case_vacuum_dust_01.mp4',
    posterWidth: 1280,
    posterHeight: 720,
  },
  {
    id: 'case-prodline-cryoblast',
    title: 'Криобластинг производственной линии',
    description: 'Очистка оборудования без разборки и остановки · Сухой лёд (CO₂)',
    method: 'Криобластинг',
    industry: 'Стекло / пищевое производство',
    poster: '/media/gallery/frames/case_prodline_cryoblast_operator.png',
    video: '/media/gallery/videos/case_prodline_cryoblast_02_operator.mp4',
    posterWidth: 1280,
    posterHeight: 720,
  },
];
