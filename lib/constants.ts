...
export const HERO_CONTENT = {
  ...
  heading: {
    ...
    highlight: 'с гарантией',
    line2: 'результата',
  },
  description: 'Восстанавливаем КПД оборудования до 95-100% и снижаем эксплуатационные расходы на 30-50%. Платите только за результат, который видите.',
  cta: {
