...
**Project:** INDAI Clean  
**Document Type:** System Prompt for AI Assistant  
**Status:** CANONICAL  
**Version:** 1.0.0  
**Created:** 2026-02-07  
**Location:** `/docs/00_УПРАВЛЕНИЕ/00_CORE/INDAI_CLOUDCODE_SYSTEM_PROMPT.md`

**Note:** This document defines the behavior of INDAI CloudCode (AI assistant) within the Cursor IDE. It is subordinate to `INDAI_MASTER_SPEC` and must be updated if canonical document structure changes.
